...
public class SociosDTO {
	...
	public SociosDTO() {}
	public SociosDTO(int rowIdSocio, String rowDNI, String rowApellido1, String rowApellido2, 
	...
	public SociosDTO(int idSocio, String nombre, String apellido1, String apellido2) {
		super();
