...
public class CrearActividadView extends JFrame{
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 828, 535);
		...
		comboBox_Instalacion.setModel(new DefaultComboBoxModel(new String[] {"Pista de Tenis 1", "Piscina 1", "Pista de Futbol 1"}));
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGap(18)
									.addComponent(comboBox_Instalacion, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE))
								.addGroup(groupLayout.createSequentialGroup()
