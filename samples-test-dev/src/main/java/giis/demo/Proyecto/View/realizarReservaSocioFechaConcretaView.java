...
public class realizarReservaSocioFechaConcretaView {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					realizarReservaSocioFechaConcretaView window = new realizarReservaSocioFechaConcretaView();
	 ...
	 */
	public realizarReservaSocioFechaConcretaView() {
		initialize();
	}
