...
public class introducirIdSocioRealizaReservaView {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					introducirIdSocioRealizaReservaView window = new introducirIdSocioRealizaReservaView();
	 ...
	 */
	public introducirIdSocioRealizaReservaView() {
		initialize();
	}
